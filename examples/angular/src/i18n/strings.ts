...
const fa: Dict = {
  ...
  calDefaultDesc: 'هدر کشویی برای ماه و سال، هفتهٔ شنبه‌محور، و [formControl] کنترل‌شده.',
...
const en: Dict = {
  ...
  calDefaultDesc: 'Dropdown month/year header, Saturday-first weeks, controlled [formControl].',
