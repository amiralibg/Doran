...
const fa: Dict = {
  ...
  calDefaultDesc: 'هدر کشویی برای ماه و سال، هفتهٔ شنبه‌محور، و bind:value کنترل‌شده.',
  ...
  calHeadlessDesc:
    'با store‌ی createCalendarGrid گریدِ خودتان را بسازید — همان منطقِ ناوبریِ مشترک، بدون کامپوننتِ آماده.',
  ...
  wgEventsDesc: 'با dayData و اسلات legend، دقیقاً مثل نسخهٔ ری‌اکت.',
...
const en: Dict = {
  ...
  calDefaultDesc: 'Dropdown month/year header, Saturday-first weeks, controlled bind:value.',
  ...
  calHeadlessDesc:
    'Build your own grid with the createCalendarGrid store — the same shared navigation logic, no ready-made component.',
  ...
  wgEventsDesc: 'Via dayData and the legend slot, exactly as in the React build.',
