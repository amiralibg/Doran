        ...
        nav: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: '@doranjs/vue', link: '/api/vue' },
              { text: '@doranjs/svelte', link: '/api/svelte' },
              { text: '@doranjs/angular', link: '/api/angular' },
              { text: '@doranjs/zod', link: '/api/zod' },
          ...
          '/guide/': [
            {
              ...
              items: [
                ...
                { text: 'بایندینگ‌های فریم‌ورک', link: '/guide/frameworks' },
                { text: 'shadcn/ui', link: '/guide/shadcn' },
                { text: 'ارتقا به ۰٫۵', link: '/guide/upgrading' },
        ...
        nav: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: '@doranjs/vue', link: '/en/api/vue' },
              { text: '@doranjs/svelte', link: '/en/api/svelte' },
              { text: '@doranjs/angular', link: '/en/api/angular' },
              { text: '@doranjs/zod', link: '/en/api/zod' },
          ...
          '/en/guide/': [
            {
              ...
              items: [
                ...
                { text: 'Framework bindings', link: '/en/guide/frameworks' },
                { text: 'shadcn/ui', link: '/en/guide/shadcn' },
                { text: 'Upgrading to 0.5', link: '/en/guide/upgrading' },
